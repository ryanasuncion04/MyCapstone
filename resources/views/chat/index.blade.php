    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-3">
                <form method="GET" action="{{ route('chat.index') }}" class="flex gap-2 mb-4">
                    <input
                        type="text"
                        name="search"
                        value="{{ $search ?? '' }}"
                    ...
                    @if(!empty($search))
                        <a href="{{ route('chat.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg text-sm">Clear</a>
                    @endif
                </form>
            </div>
            <!-- Conversations List -->

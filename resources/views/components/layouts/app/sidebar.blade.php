...
<body
    class="min-h-screen bg-white text-zinc-900 dark:bg-zinc-800 dark:text-zinc-100
    {{ \App\Models\Setting::get('layout') === 'compact' ? 'gap-2' : 'gap-4' }}">

    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-white dark:bg-zinc-900 dark:border-zinc-700">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')" class="grid">
                ...
                <flux:navlist.item icon="home" :href="route('user.map')" :current="request()->routeIs('user.map')"
                    wire:navigate>{{ __('Map') }}</flux:navlist.item>
